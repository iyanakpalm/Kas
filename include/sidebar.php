<?php 
  ...
  $jml_uang_kas = mysqli_fetch_assoc(mysqli_query($conn, "SELECT sum(minggu_ke_1) as jml_uang_kas FROM uang_kas"));
...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="index.php" class="brand-link">
    <img src="https://i.ibb.co/y6dVXHF/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
