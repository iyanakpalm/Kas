      ...
      <div class="container-fluid">
        ...
        <?php if (isset($_POST['btnLaporanPemasukkan'])): ?>
	        				...
	        				<tbody>
	        					...
	        					<?php foreach ($sql as $ds): ?>
	        						<tr>
	        							...
	        							<?php if ($ds['minggu_ke_1'] == $ds['pembayaran_perbulan']): ?>
	        ...
	        <div class="row mx-1 mb-1 mt-0">
    			<div class="col-lg-4">
    				<?php 
    					$jml_uang_kas = mysqli_fetch_assoc(mysqli_query($conn, "SELECT *, sum(minggu_ke_1) as jml_uang_kas FROM uang_kas INNER JOIN bulan_pembayaran ON bulan_pembayaran.id_bulan_pembayaran = uang_kas.id_bulan_pembayaran WHERE bulan_pembayaran.id_bulan_pembayaran = '$id_bulan_pembayaran'"));
    				?>
