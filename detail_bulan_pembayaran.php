              ...
              <?php foreach ($uang_kas as $duk): ?>
                <?php if ($_SESSION['id_jabatan'] == '3'): ?>
                  <tr>
                    ...
                    <?php if ($duk['minggu_ke_1'] == $duk['pembayaran_perbulan']): ?>
                ...
                <?php else: ?>
                  <tr>
                    ...
                    <?php if ($duk['minggu_ke_1'] == $duk['pembayaran_perbulan']): ?>
                        ...
                        <td>
                          <button type="button" class="badge badge-success" data-container="body" data-toggle="popover" data-placement="top" data-content="Tidak bisa mengubah nominal jika sudah lunas">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="form-group">
                              ...
                              <input max="<?= $duk['pembayaran_perbulan']; ?>" type="number" name="minggu_ke_1" class="form-control" value="<?= $duk['minggu_ke_1']; ?>">
                            </div>
                          </div>
...
<?php endif ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2022 By IF21D OFFICIAL.</strong>
    All rights reserved.
